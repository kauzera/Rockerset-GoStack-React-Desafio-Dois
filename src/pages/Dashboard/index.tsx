...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      responseBalance.income = formatValue(responseBalance.income);
      responseBalance.outcome = formatValue(responseBalance.outcome);
      responseBalance.total = formatValue(responseBalance.total);
